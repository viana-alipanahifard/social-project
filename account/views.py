...
class UserPasswordRestView(auth_view.PasswordResetView):
       template_name='account/password_reset_form.html'
       success_url=reverse_lazy('account:password_reset_done')
       email_template_name='account/password_reset_email.html'
       
class UserPasswordDoneResetView(auth_view.PasswordResetDoneView):
...
class PasswordResetCompleteVew(auth_view.PasswordResetCompleteView):
