...
urlpatterns = [
    ...
    path('reset/done/',views.UserPasswordDoneResetView.as_view(),name='password_reset_done'),
    path('confirm/<uidb64>/<token>',views.PasswordResetConfirmView.as_view(),name='password_reset_confirm'),
    path('confirm/complete',views.PasswordResetCompleteVew.as_view(),name='password_reset_complete'),
